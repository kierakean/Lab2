public class Lab2 {
	...
	if (manGoingToStIves) {
	    ...
	    total = 1;
		int husband = 1;
		int numSacks = numSacksPerWife*numWives;
		int numCats = numCatsPerSack*numSacks;
		int numKits = numKitsPerCat*numCats;
		
		total = total + husband + numWives + numSacks + numCats + numKits;
